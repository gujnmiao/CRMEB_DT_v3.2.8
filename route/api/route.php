...
//    Route::post('like/del', 'user.UserController/like_del')->name('likeDel');//取消点赞
    ...
    Route::post('service/submit/:id', 'community.SocialServiceController/submit')->name('serviceSubmit');
    Route::post('service/cancel/:order_id', 'community.SocialServiceController/cancel')->name('serviceCancel');
    Route::get('service/order/:order_id', 'community.SocialServiceController/order')->name('serviceOrder');
    Route::get('service/success/:order_id', 'community.SocialServiceController/paySuccess')->name('paySuccess');
...
Route::group(function () {
    ...
    //拼团数据
    Route::get('community', 'PublicController/pink')->name('pinkData');


    //拼团数据
    Route::get('community_list', 'PublicController/community_list')->name('communityList');
    Route::get('platform', 'PublicController/platform')->name('platform');
    Route::get('banner', 'PublicController/banner')->name('banner');//首页
    Route::get('service_category', 'PublicController/serviceCategory')->name('serviceCategory');
    Route::get('service_list', 'community.SocialServiceController/lst')->name('serviceList');
    Route::get('search_list', 'community.SocialServiceController/searchList')->name('searchList');
    Route::get('service/detail/:id', 'community.SocialServiceController/detail')->name('serviceDetail');
